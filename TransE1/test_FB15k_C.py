...
def entity_prediction(head_id, relation_id, entity_embeddings, relation_embeddings):
    ...
    # 使用余弦相似度来计算实体的匹配度
    # 计算 head + relation 和所有实体之间的余弦相似度
    head_relation_emb = head_emb + relation_emb
    similarities = cosine_similarity(entity_embeddings, head_relation_emb.unsqueeze(0), dim=1)
...
if __name__ == "__main__":
    ...
    test_path = "/data_disk/libh/KRL/WN18/test.txt"
